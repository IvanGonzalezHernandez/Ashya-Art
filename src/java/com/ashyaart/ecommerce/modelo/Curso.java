...
public class Curso {
    ...
    public Curso(int id, String nombre, String descripcion, double precio, String imagen, String subtitulo,
            String nivel, String duracion, String piezas_creadas, String idioma, String tipo) {
        this.id = id;
        this.nombre = nombre;
    ...
    public void setId_curso(int id) {
        this.id = id;
    }
